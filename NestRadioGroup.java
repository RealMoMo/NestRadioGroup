 ...
 * @time 2017/12/6 10:56
 * @describe  基于原生RadioGroup增加支持嵌套其他View的NestRadioGroup
 */
public class NestRadioGroup extends LinearLayout {
    ...
    public NestRadioGroup(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.NestRadioGroup, defStyleAttr, 0);
        boolean isVertical = a.getBoolean(R.styleable.NestRadioGroup_vertical,true);
        a.recycle();
